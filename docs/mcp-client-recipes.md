...
checks and forwards allowed traffic to the internal Agent Endpoint. See
[End-to-end ngrok MCP gateway](ngrok-end-to-end.md) for a runnable
upstream-to-public-Cloud-Endpoint flow.
