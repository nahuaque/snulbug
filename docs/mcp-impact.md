...
`snulbug mcp impact` previews how a candidate policy or task lease would behave
...
- exposing the proxy through ngrok, Cloudflare Tunnel, or another public tunnel
