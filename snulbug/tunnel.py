    ...
    *,
    ...
    return {
        ...
        "next_steps": [
            ...
            f"Run the generated `snulbug tunnel doctor` command before sharing the {share_target}.",
        ],
    }
        ...
        commands = [
            {
                ...
                "command": (
                    ...
                    "-c hypertele-server.json --private"
                ),
            },
            {
                ...
                "command": f"hypertele -p {client_target['port']} -c hypertele-client.json --private",
            },
        ]
        traffic_policy = None
        bridge = {
...
def _tunnel_readme(
    ...
    *,
    ...
    final_instruction = (
        ...
        else "Point MCP clients at the public MCP URL only after `snulbug tunnel doctor` passes.\n"
    )
    return (
...
def _holepunch_readme_notes(plan: Mapping[str, Any]) -> str:
    ...
    return (
        ...
        "```\n\n"
        "Run `snulbug tunnel doctor` from a machine where the client-side Hypertele "
